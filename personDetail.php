...
<div id="wrapper" style="height: 100vh">
    ...
    <div id="table_wrapper" style="border-radius: 30px; background-color: rgba(188,188,188,0.6); width: auto; height: -webkit-fill-available;">
        ...
        <div class="w-full md:w-9/12 h-64" style="width: 745px; margin-bottom: 15px; height: auto; margin-left:50px; margin-right: 50px">
            <div class="bg-white p-3 shadow-sm rounded-sm">
                <table class="min-w-max w-full table-auto bg-gray-100 bg-opacity-90" style="height: auto" id="placementsTable">
                    <thead>
...
<script>
    $('#placementsTable').DataTable({searching: false, paging: false, info: false, "order": [[ 2, "desc" ]]
    });
